...
export default function FileManagerCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new FileManager(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FileManagerCreateForm")}
      {...rest}
    >
      <TextField
        label="Key"
